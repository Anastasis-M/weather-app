...
const dict = {
  en: {
    ...
    loading_location: "Updating weather for",
    try_again: "Try again",
    ...
    rain_now: "Raining now",
    storm_now: "Storm nearby",
    snow_now: "Snowing now",
    rain_soon: "Rain likely soon",
    rain_possible_later: "Rain possible later",
    dry_now: "No rain nearby",
    sunrise: "Sunrise",
    sunset: "Sunset",
    // hourly / daily
    ...
    "map.error": "Map data unavailable",
    "map.play": "Play",
    "map.pause": "Pause",
    "map.close": "Close",
    ...
    "map.legend": "Precipitation scale",
    "map.model": "Model",
    // wmo
    "wmo.clear": "Clear",
  ...
  el: {
    ...
    loading_location: "Ενημέρωση καιρού για",
    ...
    weather_unavailable: "Η υπηρεσία καιρού δεν είναι διαθέσιμη",
    feels_like: "Αίσθηση",
    high_short: "Υ",
    low_short: "Χ",
    humidity: "Υγρασία",
    ...
    air_good: "Καλή",
    air_fair: "Μέτρια",
    air_moderate: "Επιβαρυμένη",
    air_poor: "Κακή",
    air_very_poor: "Πολύ κακή",
    air_extreme: "Ακραία",
    precip_today: "Βροχή σήμερα",
    rain_check: "Έλεγχος βροχής",
    rain_now: "Βρέχει τώρα",
    storm_now: "Καταιγίδα κοντά",
    snow_now: "Χιονίζει τώρα",
    rain_soon: "Πιθανή βροχή σύντομα",
    rain_possible_later: "Ίσως βρέξει αργότερα",
    dry_now: "Δεν φαίνεται βροχή",
    sunrise: "Ανατολή",
    sunset: "Δύση",
    ...
    "map.title": "Χάρτης καιρού",
    "map.precipitation": "Υετός",
    "map.loading": "Φόρτωση χάρτη…",
    "map.error": "Μη διαθέσιμα δεδομένα χάρτη",
    "map.play": "Αναπαραγωγή",
    "map.pause": "Παύση",
    "map.close": "Κλείσιμο",
    "map.expand": "Πλήρης οθόνη",
    "map.zoom_in": "Μεγέθυνση",
    "map.zoom_out": "Σμίκρυνση",
    "map.attribution": "Πηγές χάρτη",
    "map.legend": "Κλίμακα υετού",
    "map.model": "Μοντέλο",
    "wmo.clear": "Αίθριος",
