...
const dict = {
  en: {
    ...
    'bf.12': 'Hurricane',
    // compass
    'c.N': 'N', 'c.NNE': 'NNE', 'c.NE': 'NE', 'c.ENE': 'ENE',
    'c.E': 'E', 'c.ESE': 'ESE', 'c.SE': 'SE', 'c.SSE': 'SSE',
    'c.S': 'S', 'c.SSW': 'SSW', 'c.SW': 'SW', 'c.WSW': 'WSW',
    'c.W': 'W', 'c.WNW': 'WNW', 'c.NW': 'NW', 'c.NNW': 'NNW'
  },
  el: {
    ...
    updated: 'Ενημερώθηκε',
    powered_by: 'Με',
    permission_denied: 'Δεν επιτράπηκε η τοποθεσία. Χρησιμοποιήστε την αναζήτηση.',
    ...
    'bf.11': 'Σφοδρή θύελλα',
    'bf.12': 'Τυφώνας',
    'c.N': 'Β', 'c.NNE': 'ΒΒΑ', 'c.NE': 'ΒΑ', 'c.ENE': 'ΑΒΑ',
    'c.E': 'Α', 'c.ESE': 'ΑΝΑ', 'c.SE': 'ΝΑ', 'c.SSE': 'ΝΝΑ',
    'c.S': 'Ν', 'c.SSW': 'ΝΝΔ', 'c.SW': 'ΝΔ', 'c.WSW': 'ΔΝΔ',
    'c.W': 'Δ', 'c.WNW': 'ΔΒΔ', 'c.NW': 'ΒΔ', 'c.NNW': 'ΒΒΔ'
  }
...
export function t(key: Key | string): string {
  ...
  return table[key as string] ?? (dict.en as Record<string, string>)[key as string] ?? String(key);
}
